  ...
  */
  ...
  const togglePermission = (
    ...
    setForm(
      (previous) => {
        const exists =
          previous.permission_ids.includes(
            permissionId
          );
        ...
        return {
          ...
          permission_ids:
            exists
              ? previous.permission_ids.filter(
                  (id) =>
                    id !==
                    permissionId
                )
              : [
                  ...previous.permission_ids,
                  permissionId,
                ],
        };
      }
          ...
          <div className="flex flex-col gap-4 border-b border-gray-100 px-6 py-5 dark:border-gray-800 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Kelola role, redirect halaman, dan permission aplikasi.
              </p>
          ...
          paginatedRoles.length ===
            ...
            <div className="border-t border-gray-100 px-6 py-12 text-center dark:border-gray-800">
              ...
              <div className="mt-1 text-xs text-gray-400">
                Tambahkan role baru untuk mengatur akses user.
              </div>
          ...
          <div className="relative z-10 max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-2xl bg-white shadow-theme-xl dark:bg-gray-900">
            ...
            <div className="flex items-center justify-between border-b border-gray-100 px-6 py-5 dark:border-gray-800">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                  {editingRole
                    ? "Perbarui data role dan permission."
                    : "Tambahkan role baru dan tentukan permission."}
                </p>
              ...
              <div className="space-y-6 p-6">
                ...
                <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <p className="mt-1.5 text-xs text-gray-400">
                      Slug harus unik dan digunakan sebagai identifier role.
                    </p>
                  ...
                  <div className="md:col-span-2">
                    ...
                    <p className="mt-1.5 text-xs text-gray-400">
                      Halaman tujuan setelah user dengan role ini berhasil login.
                    </p>
                  ...
                  <div className="md:col-span-2">
                    ...
                    <textarea
                      ...
                      className="w-full resize-none rounded-lg border border-gray-300 bg-transparent px-4 py-3 text-sm outline-none placeholder:text-gray-400 focus:border-brand-500 dark:border-gray-700 dark:text-gray-300"
                    />
                ...
                <div>
                  ...
                  <div className="overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700">
                    ...
                    <div className="border-b border-gray-100 p-3 dark:border-gray-800">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="h-10 w-full rounded-lg border border-gray-300 bg-transparent pl-10 pr-4 text-sm outline-none placeholder:text-gray-400 focus:border-brand-500 dark:border-gray-700 dark:text-gray-300"
                        />
                        ...
                        (
                          ...
                          return (
                            <label
                              ...
                              className="flex cursor-pointer items-center gap-3 border-b border-gray-100 px-4 py-3 last:border-b-0 hover:bg-gray-50 dark:border-gray-800 dark:hover:bg-white/[0.03]"
                            >
                    ...
                    <div className="border-t border-gray-100 bg-gray-50/50 px-4 py-3 text-xs text-gray-500 dark:border-gray-800 dark:bg-white/[0.02] dark:text-gray-400">
